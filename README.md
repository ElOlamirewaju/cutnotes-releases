...
<p align="center">
  <a href="https://github.com/ElOlamirewaju/cutnotes-releases/releases/tag/v1.1.0"><img src="https://img.shields.io/badge/Download-v1.1.0-E8451A?style=for-the-badge&logo=apple&logoColor=white" alt="Download"></a>
...
Grab **`CutNotes-1.1.0.dmg`** from the [latest release](https://github.com/ElOlamirewaju/cutnotes-releases/releases/tag/v1.1.0).
...
1. Re-download from the [release page](https://github.com/ElOlamirewaju/cutnotes-releases/releases/tag/v1.1.0) — partial downloads can corrupt the stapled ticket
...
**v1.1.0 — Categories** *(current release)*
- ✅ Six built-in color-coded categories (VFX, Audio, Color, Edit, Review, Note)
- ✅ Custom add / rename / recolor / delete
- ✅ Toolbar dropdown showing the active note's category
- ✅ Hand-drawn line icons matching Resolve's marker palette
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="https://github.com/ElOlamirewaju/cutnotes-releases/releases/tag/v1.1.0">Download</a>
  &nbsp;·&nbsp;
